...
import 'create_gallery_post_model.dart';
export 'create_gallery_post_model.dart';

class CreateGalleryPostWidget extends StatefulWidget {
  const CreateGalleryPostWidget({super.key});

  @override
  State<CreateGalleryPostWidget> createState() =>
      _CreateGalleryPostWidgetState();
}

class _CreateGalleryPostWidgetState extends State<CreateGalleryPostWidget> {
  late CreateGalleryPostModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateGalleryPostModel());
