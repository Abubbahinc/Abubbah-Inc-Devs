                      ...
                      children: [
                        Padding(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              await widget.itineraryRef!.reference.delete();
                            },
                            child: Icon(
                        ...
                        ClipRRect(
                          ...
                          child: Image.network(
                            valueOrDefault<String>(
                              widget.itineraryRef?.locationImage != null &&
                ...
                Align(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      ...
                      await widget.itineraryRef!.reference
                          .update(createItinerariesRecordData(
                        locationImage: valueOrDefault<String>(
                          widget.itineraryRef?.locationImage != null &&
                                  widget.itineraryRef?.locationImage != ''
                              ? widget.itineraryRef?.locationImage
                              : _model.uploadedFileUrl,
                        ...
                        locationName: _model.destinationNameTextController.text,
                        caption: _model.destinationTextController.text,
                        description: _model.catchPhraseTextController.text,
                        callToAction: _model.callToActionTextController.text,
                      ));
                      Navigator.pop(context);
                    },
